...
#   c) node1 mines 32 blocks, so now node 0 has 500000POL, node 1 has 4250POL, node2 has none.
#   d) node0 sends 601 POL to node2, in two transactions (301 POL, then 300 POL).
