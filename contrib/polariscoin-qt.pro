...
HEADERS += src/bignum.h \
           ...
           src/walletdb.h \
           src/compat/sanity.h \
           src/config/polariscoin-config.h \
           src/crypto/common.h \
...
SOURCES += src/activemasternode.cpp \
           ...
           src/core_write.cpp \
           src/crypter.cpp \
           src/polariscoin-cli.cpp \
           src/polariscoin-tx.cpp \
           src/polariscoin.cpp \
           src/db.cpp \
           ...
           src/qt/polariscoin.cpp \
           src/qt/polariscoinstrings.cpp \
...
RESOURCES += src/qt/polariscoin.qrc src/qt/polariscoin_locale.qrc

TRANSLATIONS += src/qt/locale/polariscoin_bg.ts \
                src/qt/locale/polariscoin_de.ts \
                src/qt/locale/polariscoin_en.ts \
                src/qt/locale/polariscoin_es.ts \
                src/qt/locale/polariscoin_fi.ts \
                src/qt/locale/polariscoin_fr.ts \
                src/qt/locale/polariscoin_it.ts \
                src/qt/locale/polariscoin_ja.ts \
                src/qt/locale/polariscoin_pl.ts \
                src/qt/locale/polariscoin_pt.ts \
                src/qt/locale/polariscoin_ru.ts \
                src/qt/locale/polariscoin_sk.ts \
                src/qt/locale/polariscoin_sv.ts \
                src/qt/locale/polariscoin_vi.ts \
                src/qt/locale/polariscoin_zh_CN.ts \
                src/qt/locale/polariscoin_zh_TW.ts
