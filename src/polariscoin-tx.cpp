...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Polariscoin Core polariscoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  polariscoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded polariscoin transaction") + "\n" +
                               "  polariscoin-tx [options] -create [commands]   " + _("Create hex-encoded polariscoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded polariscoin transaction
