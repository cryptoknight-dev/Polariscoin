...
SplashScreen::SplashScreen(Qt::WindowFlags f, const NetworkStyle* networkStyle) : QWidget(0, f), curAlignment(0)
{
    ...
    QString titleText = tr("Polariscoin Core");
    ...
    QString copyrightTextPOL = QChar(0xA9) + QString("").arg(COPYRIGHT_YEAR) + QString(tr(" 2019 The Polariscoin Core developers"));
    ...
    pixPaint.drawText(paddingLeft, paddingTop + titleCopyrightVSpace + 36, copyrightTextPOL);
