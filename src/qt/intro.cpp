...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Polariscoin Core"),
     ...
     * override -datadir in the polariscoin.conf file in the default data directory
     * (to be consistent with polariscoind behavior)
     */
    if (dataDir != getDefaultDataDirectory())
