...
/** Utility functions used by the Polariscoin Qt UI.
 */
namespace GUIUtil
{
...
// Render POL addresses in monospace font
...
// Parse "polariscoin:" URI into recipient object, return true on successful parsing
