...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop Polariscoin server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "Polariscoin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Polariscoin features */
        {"polariscoin", "masternode", &masternode, true, true, false},
        {"polariscoin", "listmasternodes", &listmasternodes, true, true, false},
        {"polariscoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"polariscoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"polariscoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"polariscoin", "masternodedebug", &masternodedebug, true, true, false},
        {"polariscoin", "startmasternode", &startmasternode, true, true, false},
        {"polariscoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"polariscoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"polariscoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"polariscoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"polariscoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"polariscoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"polariscoin", "mnbudget", &mnbudget, true, true, false},
        {"polariscoin", "preparebudget", &preparebudget, true, true, false},
        {"polariscoin", "submitbudget", &submitbudget, true, true, false},
        {"polariscoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"polariscoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"polariscoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"polariscoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"polariscoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"polariscoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"polariscoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"polariscoin", "checkbudgets", &checkbudgets, true, true, false},
        {"polariscoin", "mnsync", &mnsync, true, true, false},
        {"polariscoin", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
...
{
    return "> polariscoin-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:7997/\n";
}
