...
This mechanism has been integrated into Bitcore-Node-Polariscoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/polariscoin/insight-api-polariscoin#web-socket-api](https://github.com/polariscoin/insight-api-polariscoin#web-socket-api)
* API: [https://github.com/polariscoin/insight-api-polariscoin#swifttx-transactions](https://github.com/polariscoin/insight-api-polariscoin#swifttx-transactions)
...
By default, the Polariscoin Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Polariscoin Core daemon:
