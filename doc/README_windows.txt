...
Intro
-----
Polariscoin (POL) is a sustainable cryptocurrency modeled after 
...
high-powered mining hardware. Polariscoin utilizes an energy efficient proof-of-stake algorithm, 
...
Setup
-----
Unpack the files into a directory and run polariscoin-qt.exe.

Polariscoin Core is the original Polariscoin client and it builds the backbone of the network.
However, it downloads and stores the entire history of Polariscoin transactions;
