...
In order to support loading of multiple wallets in polariscoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is polariscoin.cpp.
...
Changes to polariscoin.cpp
----------------------
polariscoin.cpp is the entry point into polariscoin-qt, and as such, will require some minor modifications to provide hooks for
