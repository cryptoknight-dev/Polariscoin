Contributing to Polariscoin Core
==================================

The Polariscoin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Polariscoin Core project, and is not to be
confused with overall Polariscoin Network Protocol consensus changes.

Whether a pull request is merged into Polariscoin Core rests with the project merge
...
Patches that change Polariscoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the Polariscoin consensus, it must have been
...
The project leader is the release manager for each Polariscoin Core release.
